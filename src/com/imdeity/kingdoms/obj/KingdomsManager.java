        ...
        if (checkDatabase) {
            ...
            if (query != null && query.hasRows()) {
                try {
                    ...
                    KingdomsChunk chunk = new KingdomsChunk(protectId, world, xCoord, zCoord, owner, id, (town != null ? KingdomsChunk.ChunkType.TOWN : KingdomsChunk.ChunkType.WILDERNESS), town, forSale, price, canMobsSpawn, canPvp);
